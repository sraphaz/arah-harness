...
- **H-18 Evidence Graph MVP** — export ordenado estável; `depends_on`/`supersedes` (schema); covers com glob `**`; paths Windows normalizados; runs via `ListByTask` (sem teto 500); paridade CLI↔MCP
